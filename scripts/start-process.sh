...
sleep 3
sudo -u root docker pull 717549417987.dkr.ecr.us-east-2.amazonaws.com/dev/ract:latest
if [[ $? != 0 ]]
then
...
sudo -u root docker run -d -p 80:3000 --name aws-codepipeline-project 717549417987.dkr.ecr.us-east-2.amazonaws.com/dev/ract:latest
